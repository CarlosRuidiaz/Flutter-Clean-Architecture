...
void main() {
  group('ProfileView', () {
    setUp(() {
      ...
      final profileCtrl = ProfileController(profileRepo, authRepo);
      Get.put<ProfileController>(profileCtrl);
      
      final myProjectsCtrl = Get.put<MyProjectsController>(MyProjectsController(
        Get.put(FakeProjectRepo()), Get.put(FakeAppRepo()), profileRepo, authRepo,
      ));
      
      profileCtrl.onInit();
      myProjectsCtrl.onInit();
    });
...
// Stubs needed to satisfy the dependencies for MyProjectsController 
